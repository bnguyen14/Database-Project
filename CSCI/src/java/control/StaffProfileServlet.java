...
public class StaffProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        staf.setStaff(id, email);
        request.setAttribute("id", staf.getEmployeeId());
        request.setAttribute("fname", staf.getFirstName());
        request.setAttribute("lname", staf.getLastName());
        request.setAttribute("email", staf.getEmail());
        request.setAttribute("mentors", staf.getMentors());

...
public class StudentProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("FIRSTNAME", stu.getFirstName());
        request.setAttribute("LASTNAME", stu.getLastName());
        request.setAttribute("skills", stu.getSkills());
        request.setAttribute("discipline", stu.getDiscipline());
        request.setAttribute("teams", stu.getTeams());
